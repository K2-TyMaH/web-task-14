...
class Auth:
    ...
    def verify_password(self, plain_password, hashed_password):
        ...
        :param hashed_password: Compare the password that is passed in with the hashed password stored in the database
    ...
    async def create_access_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :param self: Represent the instance of the class
        :param data: dict: Pass in the data that we want to encode into our access token
    ...
    def create_email_token(self, data: dict):
        ...
        :return: A token that can be used to verify a user's email address
        :doc-author: Trelent
        """
        to_encode = data.copy()
        expire = datetime.utcnow() + timedelta(days=7)
